<x-filament::page>
    <div class="p-4 space-y-4 bg-white rounded-lg shadow">
        <h3 class="text-lg font-medium">Listado Completo de Órdenes de Fabricación</h3>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($this->getFabricaciones() as $fabricacion)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $fabricacion->fecha_finalizacion?->format('d-m-Y') }}</td>
